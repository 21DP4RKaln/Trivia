...
<body>
    <div class="email-container">
        <div class="email-header">
            ...
            <p class="email-subtitle">Number Trivia Game</p>
        </div>
        ...
        <div class="email-body">
            ...
            <div class="message">
                Welcome to Number Trivia Game! To complete your registration and access all features, please verify your email address by clicking the button below.
            </div>
            ...
            <div class="security-info">
                <div class="security-title">Why verify your email?</div>
                <div class="security-text">
                    Email verification helps us:
                    <ul style="margin: 10px 0; padding-left: 20px;">
                        <li>Ensure we can contact you about your account</li>
                        <li>Protect your account from unauthorized access</li>
                        <li>Send you game updates and notifications</li>
